...
{
	private static final String NOT_CONFIGURED = "Vous n'avez pas configuré votre {home %1$s}, faites {/sethome %1$s} pour le configurer.";
	...
	protected void onPlayerCommand(Player player, String[] args) throws HeavenException
	{
		...
		if (!optHome.isPresent())
			throw new HeavenException(NOT_CONFIGURED, homeNumber);
