...
public class RemoveCompanyMemberQuery implements Query
{
	private static final String QUERY = "DELETE FROM companies_users WHERE company_id = ? AND user_id = ? AND employer = ? LIMIT 1;";
	...
	public RemoveCompanyMemberQuery(Company company, User user, boolean isEmployer, CompanyProvider provider)
	{
